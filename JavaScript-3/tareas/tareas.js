...
function dePalabrasAFrase(palabras) {
  ...
  // Tu código:
  resultado="";
  for (let elmt of palabras){
    resultado=resultado+' '+elmt 
  };
  return resultado
}
...
function diaDeLaSemana(n) {
  ...
  //Escribe tu código aquí
  if(n>7||n===0||typeof n!=='number'){
    return "no es un dia de la semana"
  }
  else if (typeof(n)==='number'&&(n===1||n===7)){
...
function mesesDelAño(array) {
  ...
  if (lst.length<3){return ("No se encontraron los meses pedidos")
  } else{
    return lst
  }
}
